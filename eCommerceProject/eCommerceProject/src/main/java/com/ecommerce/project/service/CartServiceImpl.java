...
public class CartServiceImpl implements CartService {
	...
	public CartDTO addProductToCart(Long productId, Integer quantity) {
		...
		CartItem cartItem = cartItemRepository.findByProductProductIdAndCartCartId(cart.getCartId(), productId);
	...
	public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
		...
		CartItem cartItem = cartItemRepository.findByProductProductIdAndCartCartId(cartId, productId);
		...
		if (updatedItem.getQuantity() == 0) {
			cartItemRepository.deleteById(updatedItem.getCartItem());
		}
